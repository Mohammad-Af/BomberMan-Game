...
public class Images {
    ...
    public static BufferedImage[] monster1WR =new BufferedImage[4];
    public static BufferedImage[] monster1WL =new BufferedImage[4];
    public static BufferedImage[] monster1WU =new BufferedImage[4];
    public static BufferedImage[] monster1WD =new BufferedImage[4];
    public static BufferedImage[] monster2WR =new BufferedImage[4];
    public static BufferedImage[] monster2WL =new BufferedImage[4];
    public static BufferedImage[] monster2WU =new BufferedImage[4];
    public static BufferedImage[] monster2WD =new BufferedImage[4];
    public static BufferedImage[] monster3WR =new BufferedImage[4];
    public static BufferedImage[] monster3WL =new BufferedImage[4];
    public static BufferedImage[] monster3WU =new BufferedImage[4];
    public static BufferedImage[] monster3WD =new BufferedImage[4];
    public static BufferedImage[] monster4WR =new BufferedImage[4];
    public static BufferedImage[] monster4WL =new BufferedImage[4];
    public static BufferedImage[] monster4WU =new BufferedImage[4];
